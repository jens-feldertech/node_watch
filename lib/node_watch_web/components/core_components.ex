defmodule NodeWatchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NodeWatchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NodeWatchWeb.Gettext, "errors", msg, opts)
    end
  end
